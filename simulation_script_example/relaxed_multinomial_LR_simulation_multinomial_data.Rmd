...
fit.mtool.cv <- mtool.multinom.cv(train = train, lambda_max = glmnet_lambda_max, alpha = 1, seed = seed, epsilon = 0.1)
fit.mtool.relaxed <- multinom.relaxed_enet_nnet(train = train, lambda_max = glmnet_lambda_max, alpha = 1, seed = seed, epsilon = 0.1)

plot(fit.glmnet.relaxed)
plot_cv.multinom(fit.mtool.cv)
