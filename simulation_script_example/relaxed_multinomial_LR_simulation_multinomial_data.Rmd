...
fit.mtool.relaxed_nnet_old_mtool$lambdagrid
fit.mtool.relaxed_nnet_old_mtool$coef_grid
...
fit.mtool.relaxed_mtool_old_mtool$lambdagrid
fit.mtool.relaxed_mtool_old_mtool$coef_grid
...
fit.mtool.relaxed_Nirupama$lambdagrid
fit.mtool.relaxed_Nirupama$coef_grid
...
fit.mtool.relaxed_correct_coefs_old_mtool <- multinom.relaxed_lasso_correct_coefs_old_mtool(train = dfM, lambda_max = glmnet_lambda_max,
                                                  gamma = 0.009, seed = seed, epsilon = 0.001)
fit.mtool.relaxed_correct_coefs_old_mtool$lambdagrid
fit.mtool.relaxed_correct_coefs_old_mtool$coef_grid
...
fit.mtool.relaxed_correct_coefs_new_mtool <- multinom.relaxed_lasso_correct_coefs_new_mtool(train = dfM, lambda_max = glmnet_lambda_max,
                                                  gamma = 0.009, seed = seed, epsilon = 0.001)
fit.mtool.relaxed_correct_coefs_new_mtool$lambdagrid
fit.mtool.relaxed_correct_coefs_new_mtool$coef_grid
```
#Plots
## Glmnet relaxed
```{r plot-glmnet}
...
## Implementation with unpenalized fit on subset using nnet using old mtool (i.e. with non-zero lambda2 value)
...
## Nirupama's implementation with penalized fit on subset using mtool, gamma = 0.009, with new mtool implementation (lambda2 = 0)
```{r plot-penalized-normal-gamma-nirupama}
print(plot_post_relaxed.multinom_test(fit.mtool.relaxed_Nirupama))
```

## Nirupama's imlementation with penalized fit on subset using mtool, gamma = 0.009, using old mtool (i.e. with non-zero lambda2 value)
```{r plot-penalized-normal-gamma-nirupama}
