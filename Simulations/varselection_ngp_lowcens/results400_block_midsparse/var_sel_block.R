...
n <- 400
p <- 20
beta <- list(c(0.5, rep(0, 3), 0.5, rep(0, 4), 0.5, rep(0, 4), 0.5, rep(0, 4), 0.5),
             c(0.2, rep(0, 3), 0.2, rep(0, 4), 0.2, rep(0, 4), 0.2, rep(0, 4), 0.2))
...
write.csv(Res, file = paste0(runif(1), "block_midsparse.csv"))
