...
do
     ID=${i}
     RUNSCRIPTS=~/projects/def-gcohenfr/ntamvada/july3_sims_finalsettings/runscripts/setting10
     LOGS=~/projects/def-gcohenfr/ntamvada/july3_sims_finalsettings/logs/setting10
echo "#!/bin/bash
#SBATCH --time=4:00:00
#SBATCH --mem=200GB
#SBATCH --nodes=1
