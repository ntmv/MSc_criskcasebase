########################### n = 400, p = 1000, Tp = 20  opposing effects ######################
library(casebase)
...
beta2 <- c(rep(0, p))
nu_ind <- seq(num_true)
beta1[nu_ind] <- c(-0.5, 0.5, -0.5, 0.5, -0.5, 0.5, -0.5, 0.5, -0.5, 0.5, -0.5, 0.5, 
                   -0.5, 0.5, -0.5, 0.5, -0.5, 0.5, -0.5, 0.5)
beta2[nu_ind] <- -beta1[nu_ind]
...
write.csv(Res, file = glue("setting12{runif(1)}.csv"))
